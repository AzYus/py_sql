...
conn = psycopg2.connect(database="personal_data", user="postgres", password="Yupi28@")

print(add_client(conn, 'John', 'Greg', 'jogre@truefalse.com'))
print(add_phone(conn, '1', '89999999999'))
print(change_client(conn, '1', 'Jane', 'Tar', 'jet@truef.com'))
print(delete_phone(conn, '1', '81111111111'))
